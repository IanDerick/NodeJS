...
// CRUD (listar e cadastrar) de usuários, com dados vindos do MySQL.
...
router.get('/novo', (req, res) => {
  res.render('usuario-form', { title: 'Cadastrar Usuário' });
});
...
router.post('/', async (req, res) => {
  ...
  try {
    await pool.execute('INSERT INTO usuarios (nome, email) VALUES (?, ?)', [
      nome.trim(),
      email.trim(),
    ]);
